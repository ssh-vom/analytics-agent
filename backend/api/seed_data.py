...
import meta
import seed_data
from duckdb_manager import capture_worldline_snapshot
from meta import (
...
def _worldline_duckdb_upload_dir(worldline_id: str) -> Path:
    return meta.DB_DIR / "worldlines" / worldline_id / "uploads" / "duckdb"
